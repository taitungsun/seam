...
**Special Education Administration & Management (SEAM) · v1.1**
...
| 💰 特殊教育經費運用結報 | 多年度、多計畫經費追蹤，自動計算執行率與餘額 |
| 🔔 提醒事項 | 整合自訂提醒與身心障礙證明到期通知，支援 `.ics` 行事曆匯入／匯出（可同步至 Google 日曆） |
| ⚙️ 系統設定 | 設定學校名稱、班型、科系清單、IEP 模板，套用至所有頁面標題與匯出報表 |
...
至 [Releases](../../releases) 頁面下載最新版 `SEAM_v1.1.html`，或直接 Clone 本儲存庫。

**2. 開啟系統**

以瀏覽器（Chrome、Edge、Firefox、Safari）開啟 `SEAM_v1.1.html`，不需要任何安裝步驟。
